...
| 常见编程指标 | Claude Opus 5.5 | GPT-6 Astra | GPT-6 Sol | GPT-6 Luna | GPT-5.6 Sol | GPT-5.6 Terra | GPT-5.6 Luna | DeepSeek V4.1 Flash | Kimi K3 | GLM-5.3 |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| DeepSWE v1.1（真实代码库中的长期修复） | — | 74.1 | 68.8 | 66.6 | 72.7 | 69.6 | 67.2 | 74.2 | 67.5 | 66.9 |
| Terminal-Bench 2.1（终端操作、规划与工具协作） | — | — | — | — | 88.8 | 87.4 | 84.7 | 90.6 | 88.3 | 88.2 |
| Terminal-Bench 4.0（更新、更难的终端 Agent 任务） | 66.4 | 57.9 | — | — | 37.3 | — | — | 31.2 | 12.6 | 37.9 |
| SWE-Bench Pro（专业软件工程问题修复） | — | — | — | — | 64.6 | 63.4 | 62.7 | — | — | — |
| FrontierCode 1.1 Extended（高难度新颖编程任务） | — | 64.5 | — | — | 60.6 | — | — | — | — | — |
| FrontierCode 1.1 Main（代码修改的可合并性） | 54.4 | 53.3 | 49.3 | 42.4 | 47.5 | — | — | — | — | — |
...
**Claude Opus 5.5 > GPT-6 Astra ≈ Claude Fable 5.1 > GPT-6 Sol  ≈ DeepSeek V4.1 Flash ≈ GPT-5.6 Sol > GPT-5.6 Terra ≈ GLM-5.3 ≈ Kimi K3 > GPT-6 Luna ≈ GPT-5.6 Luna**

如果使用 Codex 客户端，日常开发可优先试 GPT-6 Sol（思考等级为第三档），成本敏感的明确任务可试 GPT-6 Luna，复杂需求或规划可用 GPT-6 Astra；Claude Opus 5.5 适合需要高编程能力的复杂任务。

GPT-6 Sol与GPT-5.6 Sol能力差不多，有时候还会比GPT-5.6 Sol差一些，但是成本低得多。

GPT-6 Sol  、 DeepSeek V4.1 Flash、GPT-5.6 Sol 、GLM-5.3 、 Kimi K3 这些模型差距很小，可以都试试。

> 数据来源：[OpenAI API 模型页](https://developers.openai.com/api/docs/models)、[OpenAI GPT-6 Astra](https://openai.com/index/gpt-6-astra/)、[OpenAI GPT-6 Sol 和 Luna](https://openai.com/index/introducing-gpt-6-sol-and-luna/)、[OpenAI GPT-5.6](https://openai.com/index/gpt-5-6/)、[Anthropic Claude Opus 5.5](https://www.anthropic.com/claude-opus-5-5)、[FrontierCode 1.1 Main 榜单](https://stephenreid.net/frontiercode)、[DeepSeek V4.1 Flash 官方模型卡](https://huggingface.co/deepseek-ai/DeepSeek-V4.1-Flash)、[Kimi K3 官方介绍](https://www.kimi.com/en/blog/kimi-k3)、[GLM-5.3 官方模型卡](https://huggingface.co/zai-org/GLM-5.3)。
